<img alt="GoStack" src="../.github/images/header-desafios.png" />
...
Essa é uma aplicação para armazenar repositórios do seu portfólio, ela permite a criação, listagem, atualização e remoção dos repositórios, e além disso permite também que os repositórios possam receber "likes".
...
**Nota**: Acima foi utilizado `POST` em uma rota, mesmo ela alterando o número de likes do repositório sem criar nada diretamente.
